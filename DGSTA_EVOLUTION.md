...
| # | 配置 | @3 | @6 | @12 | 备注 |
|---|---|---|---|---|---|
| 1 | 原始基线 | 12.082 | 12.498 | 13.204 | PeMS08 clean baseline |
| 2 | VQ+Trend(0.1)+Delay | 11.970 | 12.484 | 13.332 | trend_fusion=0.1，@12 退化 |
| **3** | **VQ+Trend(1.0)+Delay** | **11.894** | **12.406** | **13.228** | **★ 历史最佳** |
| 4 | 3 + use_time_aware_adp | 待跑 | 待跑 | 待跑 | 待验证 |

### 失败实验（均基于实验 3 配置叠加）

| # | 改动 | @3 | @6 | @12 | 结论 |
|---|---|---|---|---|---|
| 5 | hard=False（软路由） | 11.900 | 12.455 | 13.324 | ❌ 全面退化 |
| 6 | use_spatial_trend（路网空间化趋势） | 11.938 | 12.412 | 13.242 | ❌ 轻微退化 |
| 7 | kernel=13, tau=0.5 | 11.880 | 12.407 | 13.233 | 噪声，无显著变化 |
| 8 | use_parametric_trend | 11.893 | 12.421 | 13.255 | ❌ 退化 |
| 9 | far_mask_delta=5 | 11.947 | 12.447 | 13.263 | ❌ 退化 |
| 10 | use_conv_attn | — | — | — | ❌ 退化 |
